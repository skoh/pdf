...
public class Signatures {
	 ...
	 */
	public void signPdfFirstTime(String src, String dest) throws IOException, DocumentException,
	...
	public void signPdfSecondTime(String src, String dest) throws IOException, DocumentException,
		...
		String keystore_password = "test";
		String key_password = "test";
		String alias = "test";
	...
	public void verifySignatures() throws GeneralSecurityException, IOException {
		...
		FileInputStream is2 = new FileInputStream("resources/encryption/test.cer");
...
//		
//		set OPENSSL_CONF=C:/dev/Apache2.2/conf/openssl.cnf
//		openssl req -new -out test.csr -key test.key
//		
//		openssl x509 -out test.crt -in test.csr -req -signkey test.key -days 3650
//
//		openssl pkcs12 -export -out test.p12 -inkey test.key -in test.crt -certfile test.crt -name test
//		
//		openssl pkcs12 -in test.pfx -out test.cer -nodes
//		
